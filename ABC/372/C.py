...
def break_abc(s, n, x):
    if x == 0:
        return  "".join(s[x:x+3]) == "ABC"
    elif x == 1:
        return "".join(s[x:x+3]) == "ABC" or "".join(s[x-1:x+2]) == "ABC"
    elif x == n-2:
        return "".join(s[x-1:x+2]) == "ABC" or "".join(s[x-2:x+1]) == "ABC"
    elif x == n-1:
        return "".join(s[x-2:x+1]) == "ABC"
    else:
        return "".join(s[x-2:x+1]) == "ABC" or "".join(s[x-1:x+2]) == "ABC" or "".join(s[x:x+3]) == "ABC"
...
def main():
    ...
    for _ in range(q):
        ...
        if s[xt] != ct:
            ...
            if ct == "A" and xt < n-2:
                if "".join(s[xt:xt+3]) == "ABC":
                    ans += 1

            if ct == "B" and 1 <= xt < n-1:
                if "".join(s[xt-1:xt+2]) == "ABC":
                    ans +=1
